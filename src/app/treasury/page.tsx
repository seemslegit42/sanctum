...
export default function TreasuryPage() {
  ...
  const dominanceSection = useScrollAnimation();
  ...
  return (
    <div className="container mx-auto px-4">
      ...
      <section className="py-16" ref={architectureSection.ref}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 perspective-container">
            {economicPillars.map((pillar, index) => (
                <div
                  key={pillar.title}
                  className={cn(architectureSection.isInView ? "animate-fade-in-up" : "opacity-0")}
      ...
      <section className="py-16" ref={marketSection.ref}>
        ...
        <div className={cn(marketSection.isInView ? "animate-fade-in-up" : "opacity-0")} style={{ animationDelay: '200ms' }}>
      ...
      <section className="py-16" ref={dominanceSection.ref}>
        ...
        <div className="perspective-container">
          <div className={cn(dominanceSection.isInView ? "animate-fade-in-up" : "opacity-0")} style={{ animationDelay: '200ms' }}>
            ...
            <div className={cn(dominanceSection.isInView ? "animate-fade-in-up" : "opacity-0")} style={{ animationDelay: '350ms' }}>
              <GlassCard className="p-8">
